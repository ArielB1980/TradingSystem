        ...
        while self.active:
            ...
            for symbol in markets:
                ...
                try:
                    ...
                    candles_15m = await self.kraken.get_spot_ohlcv(symbol, "15m", limit=3)
                    if candles_15m:
                    ...
                    candles_1h = await self.kraken.get_spot_ohlcv(symbol, "1h", limit=2)
                    if candles_1h:
                    ...
                    candles_4h = await self.kraken.get_spot_ohlcv(symbol, "4h", limit=2)
                    if candles_4h:
